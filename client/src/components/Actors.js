...
const Actors = ({ actor, setActor }) => {
    const fetchActor = async () => {
        const data_actor = await getActor();
        setActor(data_actor) // dataA send waited for every press in console
    }
    ...
    return (
        <>
                ...
                <button type="button" onClick={fetchActor} className="bg-gray-500 text-blue-100 py-2 px-4 rounded-lg">Actors</button>
